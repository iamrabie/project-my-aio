...
export let makeDecisionsInfo = [
  {
    ...
    des: "MY AIO use the cutting-edge GPT-4 AI model to provide the most accurate insights that anticipate market trends, giving you a competitive edge",
  },
  {
    id: 1,
    icon: <BsGraphUpArrow />,
...
export let overallRatingInfo = [
  ...
  { id: 1, icon: <BsTools />, title: "Intelligent", des: "Let's Connect" },
  {
    id: 2,
  ...
  { id: 3, icon: <GrAnnounce />, title: "Integrated", des: "Let's Connect" },
  { id: 4, icon: <FaSearchPlus />, title: "Secure", des: "Let's Connect" },
];

export let statsInfo = [
  { id: 0, total: "4,500+", title: "Businesses Empowered" },
  { id: 1, total: "10+", title: "AI Models Trained On" },
  { id: 2, total: "75%", title: "Efficiency Boost" },
];
